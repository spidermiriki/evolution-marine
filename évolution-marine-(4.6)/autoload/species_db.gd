...
const SPECIES: Dictionary = {
	...
	"crabe": {
		...
		"stamina_drain": 16.7,
		"evolves_to": ["poisson_globe", "raie", "murene", "bonite", "baliste"]
	},
	"sole": {
	...
	# Raie pastenague : furtif dans le sable, dard manuel (attack_dmg = dégâts dard)
	"raie": {
	...
	"murene": {
		"name": "Murène méditerranéenne", "emoji": "🐍", "tier": 2, "cls": "furtif",
		"radius": 22.0, "speed": 115.0, "xp_to_evolve": 200,
		"max_hp": 180, "manual_attack": false, "attack_dmg": 35.0,
		"stamina_drain": 20.0,
		"evolves_to": ["merou_geant", "wobbegong", "barracuda"]
	},
	"bonite": {
		"name": "Bonite à ventre rayé", "emoji": "🐟", "tier": 2, "cls": "rapide",
		"radius": 22.0, "speed": 380.0, "xp_to_evolve": 200,
		"max_hp": 150, "manual_attack": false, "attack_dmg": 30.0,
		"stamina_drain": 12.5,
		"evolves_to": ["merou_geant", "wobbegong", "barracuda"]
	},
	"baliste": {
		"name": "Baliste titan", "emoji": "🐡", "tier": 2, "cls": "tank",
		"radius": 28.0, "speed": 185.0, "xp_to_evolve": 200,
		"max_hp": 220, "manual_attack": false, "attack_dmg": 45.0,
		"stamina_drain": 16.7,
		"evolves_to": ["merou_geant", "wobbegong", "barracuda"]
	},
	...
	# ── PALIER 3 ──────────────────────────────────────────────────────────────
	"merou_geant": {
		"name": "Mérou géant", "emoji": "🐟", "tier": 3, "cls": "tank",
		"radius": 42.0, "speed": 190.0, "xp_to_evolve": 9999,
		"max_hp": 850, "manual_attack": false, "attack_dmg": 65.0,
		"stamina_drain": 10.0,
		"evolves_to": []
	},
	"wobbegong": {
		"name": "Wobbegong", "emoji": "🦈", "tier": 3, "cls": "furtif",
		"radius": 36.0, "speed": 210.0, "xp_to_evolve": 9999,
		"max_hp": 600, "manual_attack": false, "attack_dmg": 55.0,
		"stamina_drain": 12.5,
		"evolves_to": []
	},
	"barracuda": {
		"name": "Barracuda", "emoji": "🐟", "tier": 3, "cls": "rapide",
		"radius": 30.0, "speed": 420.0, "xp_to_evolve": 9999,
		"max_hp": 380, "manual_attack": false, "attack_dmg": 50.0,
		"stamina_drain": 8.3,
		"evolves_to": []
	},
}
